...
import edu.northeastern.cs5200.controllers.Dao.*;
...
public class JDBC_Main{
	...
	public static void main(String[] args){
		SpringApplication.run(Cs5200Spring2018JingweiApplication.class, args);
		
		System.out.println("Reconstruct Database");
		BaseDao.getInstance().reconstruction("reconstruction.sql");
			
		System.out.println("Part 1");
        Developer alice = new Developer(1, "alice", "alice", "Alice", "Wonder", "alice@wonder.com", 
						null, "4321rewq");
        Developer bob = new Developer(2, "bob", "bob", "Bob", "Marley", "bob@marley.com", null, "5432trew");
        Developer charlie = new Developer(3, "charlie", "charlie", "Charles", "Garcia", "chuch@garcia.com", 
							null, "6543ytre");
        ...
        Website facebook = new Website(1, "Facebook", "an online social media and social networking service",
    							grade, grade, 1234234);
        ...
        Website twitter = new Website(2, "Twitter", "an online news and social networking service", grade,
        						grade, 4321543);
        ...
        Website cnn = new Website(4, "CNN", "an American basic cable and satellite television news channel",
						grade, grade, 6543345);
        ...
        Website cnet = new Website(5, "CNET", "an American media website that publishes reviews, news, "
        ...
        Website gizmodo = new Website(6, "Gizmodo", "a design, technology, science and science fiction "
    						+ "website that also writes articles on politics", grade, grade, 4322345);
        ...
        Page preferences = new Page(4, "Preferences", "Where users can configure their preferences", 
        						start, due, 456776);
        ...
        Page profile = new Page(5, "Profile", "Users can configure their personal information", start,
						due, 567878);
        ...
        Widget video456 = new YouTubeWidget(6, "video456", 400, 300, 0, "https://youtu.be/h67VX51QXiQ", 
        						false, false);
